...
* Tasks
** TODO Setup export of manuscript [0/1]
- [ ] Reorganize outline (exported) vs. meta-concerns (not-exported)
- [ ] Generate PDF in separate directory
- [ ] Create makefile for batch export
- [ ] Use memoir template
- [ ] Export citations using biblatex
