...
reconfigurable à souhait.  Mais il est facile de voir que les deux buts ne sont
pas réconciliables.

# interpreter is AST -> Value + effects
# if you want to know what form Value has, you cannot change it later
# The more you specify, the less you can change later

# But what if you specify that things change?
# Yes, but what guarantees do you have then?  You can only say “I don’t know.
