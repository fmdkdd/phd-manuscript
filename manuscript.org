...
#+BEGIN_fixme
FIXME: Add diagrams.  State here that these are preliminary explorations.  Add
...
#+BEGIN_fixme
FIXME: spend more time to explain what ~with~ does exactly
#+END_fixme
...
#+BEGIN_fixme
Make answers to research questions more proeminent; more precise.  Make bolder
distinction between "small" and "up there" perspectives.
#+END_fixme
