...
#+ATTR_HTML: :style margin-top:-5rem
#+BEGIN_aside
Phénomène également relaté avec humour par Wirth [[cite:Wir-95][Wir-95]]: “Software expands to
fill the available memory”; “Software is getting slower more rapidly than
...
today’s designers are to ignore performance requirements and hardware
limitations.
#+END_QUOTE
...
With promotes Oberon while hundreds of people are telling me that an
...
la structure du système.  En 2003, Parnas déplore cette tendance:
...
**** Conclusion
Article riche: notions de modularité d’un système, d’encapsulation, et de
séparation des préoccupations.
...
Importance de la phase de conception.  Ne pas suivre le flot d’exécution, mais
plutôt encapsuler les décisions de design afin de pouvoir y apporter des
modifications sans impacter le reste du système.

Compromis efficacité/modularité.  À résoudre par un programme qui génère le
code.
...
modularity [[cite:DBB+03][DBB+03]] (design and documentation are the important part) [[cite:Par-96][Par-96]]
(admits failure at delivering a software jewel on tight hardware constraints by
trying to abstract the register allocation away but never managing to gain
enough performance back) although he is often quoted by proponents of modularity
through languages.
