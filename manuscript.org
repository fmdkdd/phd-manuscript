...
fonction en JavaScript.  On verra plus loin comment émuler ce comportement.
#+END_aside
...
JavaScript.  Mais ce faisant, on a dévié de JavaScript sur les points suivants:
...
Aucune de ces hypothèses n’est valide en JavaScript.  Cependant, il y a moyen
