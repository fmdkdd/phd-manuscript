...
with multiple dynamic analyses.  We find that diverting is a legitimate
...
JavaScript par de multiples analyses dynamiques.  Ce scénario réaliste
légitimise le détournement comme alternative à la refactorisation.  Détourner
l'interpréteur est à la fois plus rapide et plus flexible que de le réécrire,
mais a un impact potentiel sur son efficacité et sa sûreté.
...
conception.  La séplution est donc une méthodologie de développement, de la
conception à l'implémentation, dont les unités d'abstraction sont les
