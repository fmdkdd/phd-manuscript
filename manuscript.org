...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#background][Background]]
   - [[#de-l’exécution-d’un-programme-au-code-source][De l’exécution d’un programme au code source]]
   - [[#setting][Setting]]
     - [[#what-is-a-program][What is a program?]]
     - [[#what-is-a-programming-language][What is a programming language?]]
     - [[#what-is-program-modularity][What is program modularity?]]
     - [[#what-is-an-interpreter][What is an interpreter?]]
     - [[#what-does-it-mean-to-instrument-an-interpreter][What does it mean to instrument an interpreter?]]
     - [[#why-should-this-instrumentation-be-modular][Why should this instrumentation be modular?]]
     - [[#why-should-we-care-about-separation-of-concerns][Why should we care about separation of concerns?]]
     - [[#what-is-javascript][What is JavaScript?]]
     - [[#what-is-an-information-flow-analysis][What is an information flow analysis?]]
   - [[#modularity-background][Modularity background]]
   ...
   - [[#modularity-of-interpreters][Modularity of interpreters]]
     ...
     - [[#strategospoofax][Stratego/Spoofax]]
     - [[#partial-evaluation][Partial evaluation]]
   - [[#instrumentation-of-interpreters][Instrumentation of interpreters]]
   ...
   - [[#extensibility][Extensibility]]
     ...
     - [[#hyperj][Hyper/J]]
       - [[#mechanisms-for-instrumentation][Mechanisms for instrumentation]]
     - [[#others][Others?]]
       - [[#software-evolution-through-runtime-method-transformation][Software evolution through runtime method transformation]]
       - [[#direct-manipulation][Direct manipulation]]
       - [[#delta-oriented-programming][Delta-oriented programming]]
       - [[#information-transparency][Information transparency]]
       - [[#jastadd-extensible-java-compiler][JastAdd: extensible Java compiler]]
 ...
 - [[#core][Core]]
   ...
   - [[#instrumenting-the-program-vs-instrumenting-the-interpreter][Instrumenting the program vs. instrumenting the interpreter]]
...
** De l’exécution d’un programme au code source
...
#+CAPTION: Un programme (point de vue d’une machine x86).
#+BEGIN_EXAMPLE
...00101011010101011...
#+END_EXAMPLE
...
mnémoniques, et peuvent communiquer l’intention du programmeur par homonymie.
On peut, simplement en suivant les mots, supposer que le code de [[fib]] calcule et
affiche le onzième nombre de la suite de Fibonacci, sans être vraiment certain
de la sémantique de JavaScript.  Les mots /évoquent/ du sens alors que les
nombres restent silencieux[fn:misleading].

# Traduction to machine code
...
conception de programmes.  [[http://esolangs.org/wiki/Main_Page][Esolang]] recense des spécimens tels que Brainfuck,
...
[fn:misleading] Les mots peuvent également évoquer un contresens ; une
définition maladroite — ou intentionnelle — peut induire en erreur le lecteur.
Un ami m’a raconté avoir passé tout un après-midi à pister une erreur dans du
code écrit en C, pour finalement découvrir dans un fichier inclus la ligne :
~#define true false~.  Le [[http://www.ioccc.org/index.html][concours international d’obfuscation de code C]] recèle
d’exemples à suivre pour mystifier tout collaborateur.
...
in the [[#core][Core]], it might be adequate to have a dedicated background section to it.
