...
Le diagramme à gauche du code illustre les objets manipulés par l'interpréteur
...
l'objet de liaison.  Et l'objet de liaison peut être mutable: on peut y
ajouter ou y supprimer des propriétés.  Donc, on dira que la fonction ~f~
/capture statiquement un environnement mutable/.  L'environnement ne peut être
