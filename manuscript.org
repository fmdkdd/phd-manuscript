...
#+CAPTION: manipulé indirectement via un programme.  Dijkstra essaye de
...
il faut que le programme reflète ce processus.  Dijkstra cherche donc à établir
une correspondance claire entre la dimension temporelle du processus et la
dimension spatiale du programme.  Et pour lui, le ~goto~ est une construction
qui obscurcit cette correspondance.
...
# sequence + selection + iteration is enough

# GOTO harms understanding
