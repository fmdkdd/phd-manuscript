...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#inprogress-le-détournement-à-travers-lhistoire-des-langages-de-programmation][INPROGRESS Le détournement à travers l'histoire des langages de programmation]]
   ...
   - [[#inprogress-modéliser-le-monde-la-programmation-par-objets][INPROGRESS Modéliser le monde: la programmation par objets]]
...
** INPROGRESS Modéliser le monde: la programmation par objets
#+BEGIN_full-figure
...
c'est aussi un inconvénient en pratique:
