...
#+ATTR_LATEX: :options [Lewis Caroll, "Through the Looking Glass"]
#+BEGIN_epig
...
@@html:<br>— Lewis Caroll, "Through the Looking Glass"@@
#+END_epig
...
{{{author(José\, "La Classe Américaine")}}}
#+END_epigraphs
...
#+CAPTION: Les comparaisons sur les nombres sont définies dans la classe
...
different things.'
{{{author(Lewis Caroll\, "Through the Looking Glass")}}}
...
eval-double: ; Évaluation alternative
  COMEFROM eval-num
...
:UNNUMBERED: t
:END:
#+ATTR_LATEX: :options [Bob Dylan, "Blowing in the Wind"]
#+BEGIN_epig
And how many times must a man look up {{{br}}}
Before he can see the sky?
@@html:<br>— Bob Dylan, "Blowing in the Wind"@@
#+END_epig
