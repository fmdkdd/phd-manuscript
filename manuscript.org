...
la spécification: le fonctionnement attendu de l'interpréteur est modifié.
Cette modification entraîne une modification du code source, afin de modifier à
son tour l'exécution du programme.  Lorsque l'on considère que cette
spécification est nouvelle, le cycle de développement est le suivant:

[[file:img/problem1.svg]]

[describe tangled]

Avec une représentation différentielle:
