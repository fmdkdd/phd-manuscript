...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#contexte][Contexte]]
   ...
   - [[#modéliser-le-monde-la-programmation-objet][Modéliser le monde: la programmation objet]]
     ...
     - [[#bare-objects-et-prototypes-self][BARE Objects et prototypes: Self]]
...
*** BARE Objects et prototypes: Self
On peut faire de la programmation par objets sans classes et sans héritage.  Les
langages /à prototypes/, comme Self, poursuivent l'approche du tout objet et
la généralise.
...
De cette distinction philosophique, Taivalsaari tire les conclusions suivantes
...
- Les prototypes correspondent davantage au processus de réflexion humain.  En
  ...
  capturent l'essence des objets considérés.  On part plutôt d'exemples, de cas
  particuliers, que l'on relie entre eux par similarités, et en dernier vient la
  généralisation.

Le dernier point est appuyé par Lieberman
...
Prototypes can emulate class hierarchies.
