...
Pour expliquer ce qu’est un aspect, [[cite:KLM+97][KLM+97]] part d’un exemple.  Le système qui
les intéresse prend une image en noir et blanc et lui applique une série de
filtres, pour au final pouvoir reconnaître les caractères de l’image.  Ils
...
élémentaires, ~Or~, ~And~, ~Not~ créent une nouvelle image résultat, et bouclent
sur les pixels de l’image.  Un filtre composite comme ~Remove~ appelle que deux
filtres élémentaires, et donc va créer deux images intermédiaires, et itérer
deux fois sur tous les pixels de l’image: une fois dans ~And~, et une fois dans
~Not~.  Le gaspillage est encore plus important pour les filtres plus complexes,
comme ~HorizontalEdge~.

Une version optimisée de ~Remove~ ne contiendrait qu’une seule boucle et ne
créerait qu’une seule image résultat.  Mais il faut alors écrire cette version
...
filtres complexes directement.  Le système efficace comporte 35213 lignes de
code, alors que la version “simple”, mais non efficace, en comporte 768.  5 fois
plus de code à écrire, et à maintenir.  C’est d’autant plus dommage que les
versions optimisées suivent toujours le même motif: fusionner les boucles, pour
...
/fonctionnalité/ offertes par les filtres, de façon simple et homogène.  Mais
pour optimiser ces filtres complexes, il faut fusionner les boucles qui
appartiennent à des procédures différentes.  La première composition est
réalisée par la composition des procédures du langage de programmation, mais la
seconde décomposition n’est pas supportée par le langage, et doit être réalisée
manuellement.
...
système, mais plutôt la performance, des propriétés orthogonales ou
