...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#building-from-scratch-vs-extending][Building from scratch vs. extending]]
...
var interpreter = (function(){
  ...
  FunctionObject.prototype._call = function(arg, context) {
    context.scope[this.node.argName] = arg
    return execute(this.node.body, context)
  }
  ...
  function execute(node, context) {
    ...
    case 'APP':
      ...
      x = new ExecutionContext(context)
      v = f._call(a, x)
      break
