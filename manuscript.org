...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#le-problème-étendre-des-interpréteurs][Le problème: étendre des interpréteurs]]
   ...
   - [[#unread-Étude-de-cas-extension-ad-hoc-de-narcissus][UNREAD Étude de cas: extension ad-hoc de Narcissus]]
   - [[#unread-le-but-factoriser-les-changements][UNREAD Le but: factoriser les changements]]
   - [[#unwritten-lidée-le-détournement-de-programme][UNWRITTEN L'idée: le détournement de programme]]
 - [[#contexte][Contexte]]
...
** UNREAD Étude de cas: extension ad-hoc de Narcissus
...
catégories suggère des axes potentiels de /factorisation/.  Factoriser
permettrait de réduire la duplication de code, et surtout de regrouper les
changements de même nature en un seul endroit.  Par exemple, si l'interpréteur
disposait d'une fonction pour ajouter une valeur à l'objet global, tous les
ajouts à cet objets requis par l'instrumentation pourraient être effectués au
même endroit:
...
La question naturelle qui suit est: comment réaliser cette factorisation dans le
code source, par quels moyens?
...
** UNWRITTEN L'idée: le détournement de programme
