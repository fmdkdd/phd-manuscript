...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#le-problème-étendre-des-interpréteurs][Le problème: étendre des interpréteurs]]
   ...
   - [[#unread-contexte-sécuriser-linformatique-en-nuage][UNREAD Contexte: sécuriser l'informatique en nuage]]
...
** UNREAD Contexte: sécuriser l'informatique en nuage
...
construire un nouveau.  Mais, comme la section suivante va le montrer, cette
solution n'est pas non plus idéale pour implémenter plusieurs analyses.
