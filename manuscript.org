...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#Étendre-un-interpréteur-par-manipulation-de-portée][Étendre un interpréteur par manipulation de portée]]
   - [[#stable-manipuler-la-portée-des-variables-pour-linstrumentation][STABLE Manipuler la portée des variables pour l’instrumentation]]
   ...
   - [[#stable-ouvrir-le-motif-module-en-javascript][STABLE Ouvrir le motif module en JavaScript]]
   - [[#stable-Étendre-narcissus-par-manipulation-de-portée][STABLE Étendre Narcissus par manipulation de portée]]
   ...
   - [[#unstable-discussion][UNSTABLE Discussion]]
...
** STABLE Manipuler la portée des variables pour l’instrumentation
...
** STABLE Ouvrir le motif module en JavaScript
...
** STABLE Étendre Narcissus par manipulation de portée
...
#+CAPTION: définir l’ensemble des valeurs /impossibles/.
[[file:img/dls14.svg]]
#+END_side-figure
...
même dans des fichiers séparés, puisque toutes définitions résident dans le même
environnement.
...
qu’AspectScript peut capturer n’importe quel évènement du module.  En somme,
AspectScript /interprète/ le code du module, délègue l’évaluation au moteur
d’exécution sous-jacent.  Au passage, il émet des /joinpoint/ pour chaque
construction, teste les /pointcut/ pour tous les /advice/ enregistrés, et
exécute le code si le /pointcut/ correspond.

#+BEGIN_EXAMPLE
<<Exemple de code émis par AspectScript ici>>
#+END_EXAMPLE
...
#+ATTR_HTML: :class todo
#+BEGIN_aside
Show what it looks like for function calls
#+END_aside
...
#+ATTR_HTML: :class todo
#+BEGIN_aside
Isn’t the AspectScript parser taken from Narcissus?
#+END_aside
...
important en temps d’exécution et espace mémoire.  AspectScript est X fois plus
lent qu’un moteur d’exécution de JavaScript.  Sachant qu’on cherche ici à
...
#+ATTR_HTML: :class todo
#+BEGIN_aside
Numbers from AspectScript paper here
#+END_aside
...
C’est une nouvelle manifestation du compromis entre flexibilité et sécurité du
...
#+ATTR_HTML: :class todo
#+BEGIN_aside
Other downsides from DLS paper?
#+END_aside
