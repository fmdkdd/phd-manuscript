...
encore récemment, et pour pouvoir répliquer l'exemple il fallait déclarer les
fonctions par des expressions (~var f = function...~).  Le créateur de
JavaScript, Brendan Eich, [[https://bugs.chromium.org/p/v8/issues/detail?id=686][a indiqué]] que le comportement de Firefox était en
accord avec la prochaine version du standard (EcmaScript 2015).  À l'heure où
j'écris, la dernière version de Chromium (53) a maintenant le même comportement
que Firefox.
#+END_aside
...
avons vu comment répliquer une forme de portée dynamique en JavaScript pour
...
#+ATTR_HTML: :style margin-top:12rem
#+BEGIN_aside
D'où les nombreuses illustrations qui parsèment ce document.
#+END_aside
