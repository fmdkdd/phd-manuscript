...
particulier.  En conséquence, il convient de privilégier l'indirection pour
modifier le comportement d'un programme, pour le détourner.  C'est ce que l'on
va faire dans les chapitres suivants.
