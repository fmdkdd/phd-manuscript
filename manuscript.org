...
# org-babel-use-quick-and-dirty-noweb-expansion: t; org-image-actual-width: 300; # ispell-local-dictionary: "french" -*-
#+STARTUP: nologdone
...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#État-de-lart][État de l'art]]
   ...
   - [[#tisser-les-facettes-dun-artefact-dinnombrable-dimensions][Tisser les facettes d'un artefact d'innombrable dimensions]]
     - [[#translate-la-programmation-littéraire][TRANSLATE La programmation littéraire]]
       - [[#mechanisms-for-extension-2][Mechanisms for extension]]
     - [[#stable-hyperj][STABLE Hyper/J]]
     - [[#stable-linformation-transparente][STABLE L'information transparente]]
   ...
   - [[#unstable-travaux-connexes-concernant-linstrumentation][UNSTABLE Travaux connexes concernant l'instrumentation]]
     ...
     - [[#translate-lua][TRANSLATE Lua]]
        - [[#mechanisms-for-extension-6][Mechanisms for extension]]
...
*** TRANSLATE La programmation littéraire
...
programme /avant tout/ pour un humain, et en second lieu pour la machine.  La
machine n'a que faire des considérations de style, ou de l'ordre de présentation
du programme; le code source suffit.  Pour l'humain en revanche, les
explications sont très utiles pour comprendre le fonctionnement du programme et
...
First part is TeX, second part is Pascal.  Pascal has references to other
sections, which are described elsewhere.  Code is written as it should be shown
to the human first.

Two outputs: TANGLE and WEAVE.
...
*** STABLE L'information transparente
...
Eclipse [??] affiche une liste de toutes les tâches du projet, construite en
glanant ces mots-clés.

#+ATTR_HTML: :class todo :style margin-top:6rem
#+BEGIN_aside
Ref Eclipse
#+END_aside
