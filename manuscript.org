...
ordinateur simple d'accès, intuitif, et qui peut servir à tout usage.  Le
système développé par le LRG s'appellera Smalltalk.
...
#+BEGIN_QUOTE
For the first I thought of the whole as the entire computer and wondered why
anyone would want to divide it up into weaker things called data structures and
