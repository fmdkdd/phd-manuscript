...
rappelle le patron /Interpreter/ [[cite:GHJ+94][GHJ+94]].
...
Le second terme du langage représente l'addition entre deux constantes.  Dans
notre implémentation par objets, on ajoute le terme est en créant un objet
