...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#inprogress-une-chronologie-du-détournement-dans-les-langages-de-programmation][INPROGRESS Une chronologie du détournement dans les langages de programmation]]
   - [[#unread-apprivoiser-le-flot-de-contrôle-la-programmation-structurée][UNREAD Apprivoiser le flot de contrôle: la programmation structurée]]
   - [[#inprogress-la-programmation-littéraire][INPROGRESS La programmation littéraire]]
...
* INPROGRESS Une chronologie du détournement dans les langages de programmation
:PROPERTIES:
:CUSTOM_ID: chrono
:END:
** UNREAD Apprivoiser le flot de contrôle: la programmation structurée
#+BEGIN_epig
...
direct dans le second programme; ce programme est donc plus clair.  ~COMEFROM~
...
vilipendée.  Le message de la programmation structurée est de clarifier la
correspondance programme-processus, pas d'abolir les ~GOTO~.
...
** INPROGRESS La programmation littéraire
:PROPERTIES:
:CUSTOM_ID: proglit
:END:
