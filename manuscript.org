...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#le-problème-étendre-des-interpréteurs][Le problème: étendre des interpréteurs]]
   ...
   - [[#bare-modifier-un-programme-sans-modifier-son-code-source][BARE Modifier un programme sans modifier son code source]]
...
with multiple dynamic analyses.  We find that diverting is both faster and more
flexible than rewriting the interpreter, but bears potential costs in efficiency
and program safety.  Diverting is thus a legitimate alternative to refactoring
for this realistic use-case.
...
JavaScript par de multiples analyses dynamiques.  Détourner l'interpréteur est à
la fois plus rapide et plus flexible que de le réécrire, mais a un impact
potentiel sur son efficacité et sa sûreté.  Le détournement est donc une
alternative légitime à la refactorisation dans ce scénario réaliste.
...
** BARE Modifier un programme sans modifier son code source
