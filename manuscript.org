...
fonction ~execute~ de Narcissus est donc séparé: chaque nœud possède le code qui
permet d’évaluer sa valeurs et ses effets.

Écrivons un interpréteur pour \lambda^{standard} dans ce style.
