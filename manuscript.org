...
[fn:s3c] Dans les programmes qui suivent, le trigramme ~//:~ indique la valeur
de l’expression qui précède.  C’est la syntaxe de l’éditeur interactif [[cite:s3c][s3c]] que
j’ai développé pour les cours de JavaScript.
