...
*** Solution: patrons visiteur
Combiner le patron interpréteur et le patron visiteur permet de d'ajouter des
opérations.  Mais il y a un problème de type: un visiteur ne supportera pas
nécessairement les futures variantes.  Krishnamurthi, Felleisen et Friedman
proposent le visiteur extensible pour y remédier [[cite:KFF-98][KFF-98]].  Dans le visiteur
extensible, on ajoute un constructeur virtuel (/factory/).
