...
Et on dispose d'une définition alternative de ~Y~, ~Y2~:

: <<Y2>>= ...

Le problème est que l'on souhaite pouvoir dire, pendant l'entrelacement du bloc
~X~, d'utiliser soit ~Y~ soit ~Y2~.  Ce n'est pas possible directement en noweb.
...
le contenu du bloc ~Y2~ à chaque référence faite au bloc ~Y~.  De cette façon,
