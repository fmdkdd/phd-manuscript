...
#+BEGIN_side-figure
#+CAPTION: Pour Naur, le code source n’est qu’un produit secondaire de
#+CAPTION: l’activité principale du programmeur qui est la construction
#+CAPTION: d’une connaissance du problème.
