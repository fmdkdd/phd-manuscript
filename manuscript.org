...
#+TODO: BARE(b) UNSTABLE(u) TRANSLATE(t) MISPLACED(m) | STABLE(d)
...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#le-problème-étendre-des-interpréteurs][Le problème: étendre des interpréteurs]]
   - [[#unstable-préliminaires-code-source-processus-et-spécification][UNSTABLE Préliminaires: code source, processus, et spécification]]
   - [[#unstable-Étude-de-cas-extension-ad-hoc-de-narcissus][UNSTABLE Étude de cas: extension ad-hoc de Narcissus]]
   - [[#bare-le-but-factoriser-les-changements][BARE Le but: factoriser les changements]]
   - [[#misplaced-le-problème-de-lexpression][MISPLACED Le problème de l'expression]]
   - [[#lidée-le-détournement-de-programme][L'idée: le détournement de programme]]
 - [[#contexte][Contexte]]
   ...
   - [[#stable-tisser-les-facettes-dun-artefact-dinnombrables-dimensions][STABLE Tisser les facettes d'un artefact d'innombrables dimensions]]
 ...
 - [[#bare-synthèse][BARE Synthèse]]
   ...
   - [[#bare-perspectives-if-automated-programming-is-the-future-this-is-mostly-usesless][BARE Perspectives: if automated programming is the future, this is mostly usesless]]
...
:CUSTOM_ID: problem
:END:
** UNSTABLE Préliminaires: code source, processus, et spécification
:PROPERTIES:
:CUSTOM_ID: defs
:END:
...
** BARE Le but: factoriser les changements
...
** MISPLACED Le problème de l'expression
...
** STABLE Tisser les facettes d'un artefact d'innombrables dimensions
#+BEGIN_epig
...
** BARE Perspectives: if automated programming is the future, this is mostly usesless
