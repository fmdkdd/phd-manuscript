...
* Contents                                                   :TOC@4:noexport:
 ...
 - [[#translate-Étendre-un-interpréteur-par-manipulation-de-portée][TRANSLATE Étendre un interpréteur par manipulation de portée]]
   ...
   - [[#Étendre-narcissus-par-manipulation-de-portée][Étendre Narcissus par manipulation de portée]]
     ...
     - [[#ajouter-l’analyse-de-trace][Ajouter l’analyse de trace]]
     - [[#ajouter-l’analyse-flowr][Ajouter l’analyse FlowR]]
     - [[#ajouter-l’analyse-d’environnements][Ajouter l’analyse d’environnements]]
...
même principle que pour ~around~, mais appliqué aux objets.
...
#+BEGIN_SRC js
i13n.pushLayer(___, {
  FunctionObject: i13n.override(___.FunctionObject, {
    __call__: flowrCall }),
...
section [[*Disposer les environnements en couches]], on peut activer plusieurs
analyses à l’exécution avec des options de lancement.  Par exemple:
...
des deux sorties permet de visualiser à quel moment de l’interprétation les
