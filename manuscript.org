...
utilisé dans ~execute~.  Enfin, une nouvelle fonction est exportée par le module.

# Hence, working with this reduced example is meaningful.

# Duplication should not be needed for such small changes.
