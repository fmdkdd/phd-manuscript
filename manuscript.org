...
old clarity about what's actually happening. — [[cite:FF-04][FF-04]]
#+END_QUOTE

D'après eux, un mécanisme pour la programmation par aspect peut se résumer à
faire des déclarations de la forme:

: Dans les programmes P, quand la condition C est remplie, faire l'action A.

Ce qui suggère trois axes de liberté pour ces mécanismes:
