...
- bibtex2html 1.98
- xmlstarlet 1.6.1, GNU parallel 20160222, rsvg-convert 2.4.16 (for SVG export)
...
[[https://en.wikipedia.org/wiki/Source_Code_Pro][Source Code Pro]] for the code snippets.
