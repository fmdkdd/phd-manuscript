...
\renewcommand*{\cftchapterformatpnum}[1]{%
  \oldchapterfpnum{\pageword{#1}}}

\let\oldsectionfpnum\cftsectionformatpnum
\renewcommand*{\cftsectionformatpnum}[1]{%
  \oldsectionfpnum{\pageword{#1}}}
...
\newcommand{\marginhead}[1]{%
  ...
  \parbox{\fullwidth}{#1}}
%% This command overrides the font style, we restore the default
\setsecheadstyle{\Large\bfseries\marginhead}
