...
%% Left justification of the whole document.  Full justification is superficial.
%% 'side' option is passed to footmisc for footnotes on the side.
\usepackage[document, side]{ragged2e}

%% Ragged2e sets parindent to 0 otherwise paragraphs look unbalanced.  The
%% default parskip is too subtle to tell when a paragraph begins however.
